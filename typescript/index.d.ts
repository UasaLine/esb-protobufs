...
export namespace mindbox {
  ...
  export interface Mobile {
    creation(
      request: ParamsCreation,
      metadata?: any
    ): Observable<ResponseCreation>;
    authorization(
      request: ParamsAuthorization,
      metadata?: any
    ): Observable<ResponseAuthorization>;
    registration(
      request: ParamsRegistration,
      metadata?: any
    ): Observable<ResponseRegistration>;
  ...
  export interface ParamsAuthorization {
    device_uuid: string;
  }
  ...
  export interface ParamsRegistration {
    device_uuid: string;
    client_id: string;
    email: string;
    full_name: string;
  ...
  export interface ParamsCreation {
    device_uuid: string;
    id: string;
    vendor: string;
    model: string;
